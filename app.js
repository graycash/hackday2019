...
class Enemy extends Populate {
  constructor (x, y, speed,imageloc) {
    super();
    this.x = x;
    this.y = y;
    this.speed = speed;
...
const enemy1 = new Enemy(101, 83, 150, "images/char-boy.png");
const enemy2 = new Enemy(404, 166, 350, "images/char-horn-girl.png");
const enemy3 = new Enemy(0, 249, 375,  "images/char-pink-girl.png");
const enemy4 = new Enemy(0, 83, 100,"images/char-princess-girl.png");
const enemy5 = new Enemy(300, 200, 400,"images/char-cat-girl.png" )
